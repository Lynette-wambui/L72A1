...
-- Select all records from the NOBEL_WIN table where the subject does not start with 'B'
SELECT * 
FROM NOBEL_WIN 
WHERE SUBJECT NOT LIKE 'B%'
AND SUBJECT NOT LIKE 'P%'
AND SUBJECT NOT LIKE 'L%';
...
INSERT INTO NOBEL_WIN (YEAR, SUBJECT, WINNER, COUNTRY, CATEGORY) VALUES
  ...
  (1973, 'BIOLOGY', 'PHILIPS', 'USA', 'PRIME MINISTER'),
  (1980, 'BIOLOGY', 'MARTIN', 'USA', 'PRESIDENT'),
  (2981, 'PHYSIOLOGY', 'HANNAH', 'HUNGARY', 'SCIENTIST'),
  (3975, 'PHYSICS', 'PETER', 'CHILE', 'SCIENTIST');
